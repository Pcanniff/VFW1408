...
// in simulator we redefine to format for Canniff_Philip_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_Project1NativeItemNone = -1, 
	UICanniff_Philip_Project1NativeItemSpinner = -2,
	UICanniff_Philip_Project1NativeItemProgressBar = -3,
	
	UICanniff_Philip_Project1NativeItemSlider = -4,
	UICanniff_Philip_Project1NativeItemSwitch = -5,
	UICanniff_Philip_Project1NativeItemMultiButton = -6,
	UICanniff_Philip_Project1NativeItemSegmented = -7,
	
	UICanniff_Philip_Project1NativeItemTextView = -8,
	UICanniff_Philip_Project1NativeItemTextField = -9,
	UICanniff_Philip_Project1NativeItemSearchBar = -10,
	
	UICanniff_Philip_Project1NativeItemPicker = -11,
	UICanniff_Philip_Project1NativeItemDatePicker = -12,
	
	UICanniff_Philip_Project1NativeItemInfoLight = -13,
	UICanniff_Philip_Project1NativeItemInfoDark = -14,
	
	UICanniff_Philip_Project1NativeItemDisclosure = -15,
	
	UICanniff_Philip_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_Project1 instances of
