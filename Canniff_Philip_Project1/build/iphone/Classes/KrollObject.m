...
//@interface Canniff_Philip_Project1Object : NSObject
//@end

@interface Canniff_Philip_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_Project1Object class]])
		{
			for (NSString *key in [[(Canniff_Philip_Project1Object*)o modules] allKeys])
			{
