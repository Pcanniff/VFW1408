 ...
 * to send analytic data that can be viewed on the Canniff_Philip_Project1 Dashboard.
 *
 * For information on getting started with Canniff_Philip_Project1 Platform Services,
