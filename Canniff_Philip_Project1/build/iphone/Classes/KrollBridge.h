...
@interface Canniff_Philip_Project1Object : KrollCoverageObject {
#else
@interface Canniff_Philip_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_Project1Object *_canniff_philip_project1;
    KrollObject* console;
	BOOL shutdown;
