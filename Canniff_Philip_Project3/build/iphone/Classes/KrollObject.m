...
//@interface Canniff_Philip_Project3Object : NSObject
//@end

@interface Canniff_Philip_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_Project3Object class]])
		{
			for (NSString *key in [[(Canniff_Philip_Project3Object*)o modules] allKeys])
			{
