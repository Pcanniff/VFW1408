...
@interface Canniff_Philip_Project3Object : KrollCoverageObject {
#else
@interface Canniff_Philip_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_Project3Object *_canniff_philip_project3;
    KrollObject* console;
	BOOL shutdown;
