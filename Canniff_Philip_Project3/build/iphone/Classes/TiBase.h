...
// in simulator we redefine to format for Canniff_Philip_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_Project3NativeItemNone = -1, 
	UICanniff_Philip_Project3NativeItemSpinner = -2,
	UICanniff_Philip_Project3NativeItemProgressBar = -3,
	
	UICanniff_Philip_Project3NativeItemSlider = -4,
	UICanniff_Philip_Project3NativeItemSwitch = -5,
	UICanniff_Philip_Project3NativeItemMultiButton = -6,
	UICanniff_Philip_Project3NativeItemSegmented = -7,
	
	UICanniff_Philip_Project3NativeItemTextView = -8,
	UICanniff_Philip_Project3NativeItemTextField = -9,
	UICanniff_Philip_Project3NativeItemSearchBar = -10,
	
	UICanniff_Philip_Project3NativeItemPicker = -11,
	UICanniff_Philip_Project3NativeItemDatePicker = -12,
	
	UICanniff_Philip_Project3NativeItemInfoLight = -13,
	UICanniff_Philip_Project3NativeItemInfoDark = -14,
	
	UICanniff_Philip_Project3NativeItemDisclosure = -15,
	
	UICanniff_Philip_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_Project3 instances of
