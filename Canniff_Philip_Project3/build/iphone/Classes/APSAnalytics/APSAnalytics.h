 ...
 * to send analytic data that can be viewed on the Canniff_Philip_Project3 Dashboard.
 *
 * For information on getting started with Canniff_Philip_Project3 Platform Services,
