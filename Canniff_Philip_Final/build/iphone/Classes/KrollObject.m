...
//@interface Canniff_Philip_FinalObject : NSObject
//@end

@interface Canniff_Philip_FinalObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_FinalObject class]])
		{
			for (NSString *key in [[(Canniff_Philip_FinalObject*)o modules] allKeys])
			{
