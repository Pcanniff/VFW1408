...
@interface Canniff_Philip_FinalObject : KrollCoverageObject {
#else
@interface Canniff_Philip_FinalObject : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_Final$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_FinalObject *_canniff_philip_final;
    KrollObject* console;
	BOOL shutdown;
