...
/**
 Base class for all Canniff_Philip_Final views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_Final view hierarchy (such as wrapped iOS UIViews) was touched.
