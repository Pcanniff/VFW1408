...
// in simulator we redefine to format for Canniff_Philip_Final Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_final." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_final";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_FinalNativeItemNone = -1, 
	UICanniff_Philip_FinalNativeItemSpinner = -2,
	UICanniff_Philip_FinalNativeItemProgressBar = -3,
	
	UICanniff_Philip_FinalNativeItemSlider = -4,
	UICanniff_Philip_FinalNativeItemSwitch = -5,
	UICanniff_Philip_FinalNativeItemMultiButton = -6,
	UICanniff_Philip_FinalNativeItemSegmented = -7,
	
	UICanniff_Philip_FinalNativeItemTextView = -8,
	UICanniff_Philip_FinalNativeItemTextField = -9,
	UICanniff_Philip_FinalNativeItemSearchBar = -10,
	
	UICanniff_Philip_FinalNativeItemPicker = -11,
	UICanniff_Philip_FinalNativeItemDatePicker = -12,
	
	UICanniff_Philip_FinalNativeItemInfoLight = -13,
	UICanniff_Philip_FinalNativeItemInfoDark = -14,
	
	UICanniff_Philip_FinalNativeItemDisclosure = -15,
	
	UICanniff_Philip_FinalNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_Final instances of
