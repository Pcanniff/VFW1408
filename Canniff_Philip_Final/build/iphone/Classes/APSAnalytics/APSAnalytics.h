 ...
 * to send analytic data that can be viewed on the Canniff_Philip_Final Dashboard.
 *
 * For information on getting started with Canniff_Philip_Final Platform Services,
